        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body row">
                    ...
                    <div class="col-md-4">
                        <a href="{{ route('financial.transactions.create', 'expense') }}"
                            class="btn btn-block btn-outline-warning btn-lg"><i class="fa fa-plus"></i>
                            Cadastrar despesa</a>

                        <a href="{{ route('financial.transactions.create', 'revenue') }}"
                            class="btn btn-block btn-outline-warning btn-lg"><i class="fa fa-plus"></i>
                            Cadastrar receita</a>
                    </div>
                    <div class="col-md-4">
